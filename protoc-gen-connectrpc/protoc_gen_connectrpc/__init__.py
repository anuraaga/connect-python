...
@dataclass
class Options:
    google_compat: bool = False
    """Whether to target google.protobuf instead of protobuf-py"""
...
def _generate_async_stubs(f: File, service: DescService, options: Options) -> None:
    ...
    default_server_codecs = "_DEFAULT_CODECS" if options.google_compat else "None"
...
def _generate_sync_stubs(f: File, service: DescService, options: Options) -> None:
    ...
    default_codecs = "_DEFAULT_CODECS" if options.google_compat else "None"
