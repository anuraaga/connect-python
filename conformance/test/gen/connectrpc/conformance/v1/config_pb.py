...
class Config(Message[Literal["features", "include_cases", "exclude_cases"]]):
    """
...
class Features(Message[Literal["versions", "protocols", "codecs", "compressions", "stream_types", "supports_h2c", "supports_tls", "supports_tls_client_certs", "supports_trailers", "supports_half_duplex_bidi_over_http1", "supports_connect_get", "supports_message_receive_limit"]]):
    """
...
class ConfigCase(Message[Literal["version", "protocol", "codec", "compression", "stream_type", "use_tls", "use_tls_client_certs", "use_message_receive_limit"]]):
    """
...
class TLSCreds(Message[Literal["cert", "key"]]):
    """
