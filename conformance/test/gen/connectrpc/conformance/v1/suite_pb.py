...
class TestSuite(Message[Literal["name", "mode", "test_cases", "relevant_protocols", "relevant_http_versions", "relevant_codecs", "relevant_compressions", "connect_version_mode", "relies_on_tls", "relies_on_tls_client_certs", "relies_on_connect_get", "relies_on_message_receive_limit"]]):
    """
...
class TestCase(Message[Literal["request", "expand_requests", "expected_response", "other_allowed_error_codes"]]):
    """
    ```proto
    ...
    class ExpandedSize(Message[Literal["size_relative_to_limit"]]):
        """
        ```proto
