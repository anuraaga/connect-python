...
class ClientCompatRequest(Message[Literal["test_name", "http_version", "protocol", "codec", "compression", "host", "port", "server_tls_cert", "client_tls_creds", "message_receive_limit", "service", "method", "stream_type", "use_get_http_method", "request_headers", "request_messages", "timeout_ms", "request_delay_ms", "cancel", "raw_request"]]):
    """
    ...
    class Cancel(Message[Literal["before_close_send", "after_close_send_ms", "after_num_responses"]]):
        """
        ```proto
...
class ClientCompatResponse(Message[Literal["test_name", "response", "error"]]):
    """
...
class ClientResponseResult(Message[Literal["response_headers", "payloads", "error", "response_trailers", "num_unsent_requests", "http_status_code", "feedback"]]):
    """
...
class ClientErrorResult(Message[Literal["message"]]):
    """
...
class WireDetails(Message[Literal["actual_status_code", "connect_error_raw", "actual_http_trailers", "actual_grpcweb_trailers"]]):
    """
