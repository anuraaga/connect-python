...
class UnaryResponseDefinition(Message[Literal["response_headers", "response_data", "error", "response_trailers", "response_delay_ms", "raw_response"]]):
    """
...
class StreamResponseDefinition(Message[Literal["response_headers", "response_data", "response_delay_ms", "error", "response_trailers", "raw_response"]]):
    """
...
class UnaryRequest(Message[Literal["response_definition", "request_data"]]):
    """
    ```proto
...
class UnaryResponse(Message[Literal["payload"]]):
    """
    ```proto
...
class IdempotentUnaryRequest(Message[Literal["response_definition", "request_data"]]):
    """
    ```proto
...
class IdempotentUnaryResponse(Message[Literal["payload"]]):
    """
    ```proto
...
class ServerStreamRequest(Message[Literal["response_definition", "request_data"]]):
    """
    ```proto
...
class ServerStreamResponse(Message[Literal["payload"]]):
    """
    ```proto
...
class ClientStreamRequest(Message[Literal["response_definition", "request_data"]]):
    """
    ```proto
...
class ClientStreamResponse(Message[Literal["payload"]]):
    """
    ```proto
...
class BidiStreamRequest(Message[Literal["response_definition", "full_duplex", "request_data"]]):
    """
    ```proto
...
class BidiStreamResponse(Message[Literal["payload"]]):
    """
    ```proto
...
class UnimplementedRequest(Message[NoReturn]):
    """
    ```proto
...
class UnimplementedResponse(Message[NoReturn]):
    """
    ```proto
...
class ConformancePayload(Message[Literal["data", "request_info"]]):
    """
    ```proto
    ...
    class RequestInfo(Message[Literal["request_headers", "timeout_ms", "requests", "connect_get_info"]]):
        """
        ```proto
    ...
    class ConnectGetInfo(Message[Literal["query_params"]]):
        """
        ```proto
...
class Error(Message[Literal["code", "message", "details"]]):
    """
...
class Header(Message[Literal["name", "value"]]):
    """
...
class RawHTTPRequest(Message[Literal["verb", "uri", "headers", "raw_query_params", "encoded_query_params", "unary", "stream"]]):
    """
    ...
    class EncodedQueryParam(Message[Literal["name", "value", "base64_encode"]]):
        """
        ```proto
...
class MessageContents(Message[Literal["binary", "text", "binary_message", "compression"]]):
    """
...
class StreamContents(Message[Literal["items"]]):
    """
    ...
    class StreamItem(Message[Literal["flags", "length", "payload"]]):
        """
        ```proto
...
class RawHTTPResponse(Message[Literal["status_code", "headers", "unary", "stream", "trailers"]]):
    """
