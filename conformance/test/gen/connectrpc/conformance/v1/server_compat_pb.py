...
class ServerCompatRequest(Message[Literal["protocol", "http_version", "use_tls", "client_tls_cert", "message_receive_limit", "server_creds"]]):
    """
...
class ServerCompatResponse(Message[Literal["host", "port", "pem_cert"]]):
    """
